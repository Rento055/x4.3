...
function p5(v)
    edit(0x2eedac, v, "にゃんこチケット", true);
    gg.toast("にゃんチケ成功");
end

function p7(v)
    edit(0x2eedb4, v, "レアチケット", true);
    gg.toast("レア成功");
end
...
function p11(v)
    gg.clearResults();
    gg.searchNumber("-257~~256", 4, false, 2^29, base +0x3aa38, base + 0x3b6e4);
...
function p12()
    local err = {156,183,286,321,340,354,433,434,466,493,498,499,500,501,674,741,742,743,744,745,746,789,800,801,802,803,804,805,806,807,808,809,810,811};
    local editval = gg.getValues({{address = base +0x3b6e4, flags = 4}})[1].value;
