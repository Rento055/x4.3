...
function p5(v)
    edit(0x2e7194, v, "にゃんこチケット", true);
    gg.toast("にゃんチケ成功");
end

function p7(v)
    edit(0x2e719c, v, "レアチケット", true);
    gg.toast("レア成功");
end
...
function p12()
    local err = {156,183,286,321,340,354,433,434,466,493,498,499,500,501,674,741,742,743,744,745,746,789};
